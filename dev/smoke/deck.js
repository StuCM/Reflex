...
module.exports = function (h) {
  const { deckWrites, shot, press, waitFor, step, openSidebar, sidebarRows,
    sidebarPick, deckRow, focusDeck, onMain, onBackup, onBoth, waitForConfirm,
    takeConfirm, cachedRows, reloadDeck, backToLibrary, openTitle, actionRow,
    pressButton, page, titles } = h;
