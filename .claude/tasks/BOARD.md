...
| 019 | One suite, many files, and a free port | `building` | laptop | crew/019-split-the-smoke-suite |
...
- **019 One suite, many files, and a free port** — `building` on `crew/019-split-the-smoke-suite`
